...
top_20_countries_db <-head(country_summary, 20)
top_20_continent_vec <- c("Europe","Europe","Europe","Europe","Europe","Europe", "Asia", "Oceania","North America","Oceania","Europe","Central America","Europe","Europe","North America","Europe","Europe","Europe","North America","Europe")  

top_20_countries_db$Continent <- top_20_continent_vec
top_20_countries <- head(country_summary$Country_name, 20)


# Bottom 20 (worst average rank)
bottom_20_countries_db <- tail(country_summary, 20)
bottom_20_continent_vec <- c("Africa","Africa","Africa","Africa","Central America","Africa", "Africa","Africa","Africa","Africa","Africa","Africa","Africa","Asia","Africa","Africa","Africa","Asia","Africa","Africa")
bottom_20_countries_db$Continent <- bottom_20_continent_vec
bottom_20_countries <- tail(country_summary$Country_name, 20)

print(top_20_countries_db)
print(bottom_20_countries_db)


# Label each group
top_20_countries_db$Group <- "Top 20"
bottom_20_countries_db$Group <- "Bottom 20"

# Combine
continent_data <- bind_rows(top_20_countries_db, bottom_20_countries_db)

ggplot(continent_data, aes(x = Continent, fill = Continent)) +
  geom_bar() +
  facet_wrap(~ Group, nrow = 1) +  # facets in a row
  labs(title = "Continent Distribution of Top 20 and Bottom 20 Countries",
...
random_13_top_logGDP <- sample(top_20_countries, 13)
random_13_bottom_logGDP <- sample(bottom_20_countries, 13)
blue_countries <- random_13_top_logGDP
red_countries  <- random_13_bottom_logGDP
...
random_13_top_social_support <- sample(top_20_countries, 13)
random_13_bottom_social_support <- sample(bottom_20_countries, 13)
blue_countries <- random_13_top_social_support
red_countries  <- random_13_bottom_social_support
...
random_13_top_pos_emotions <- sample(top_20_countries, 13)
random_13_bottom_pos_emotions <- sample(bottom_20_countries, 13)
blue_countries <- random_13_top_pos_emotions
red_countries  <- random_13_bottom_pos_emotions
...
random_13_top_life_expectancy <- sample(top_20_countries, 13)
random_13_bottom_life_expectancy <- sample(bottom_20_countries, 13)
blue_countries <- random_13_top_life_expectancy
red_countries  <- random_13_bottom_life_expectancy
