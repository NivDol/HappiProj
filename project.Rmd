...
total_rows <- nrow(happiness_data)

# Print info
cat("Train rows:", train_rows, "(", round(100 * train_rows / total_rows, 2), "% )\n")
cat("Test rows :", test_rows,  "(", round(100 * test_rows / total_rows, 2), "% )\n")
...
the second model training without the former top_20 with the randomized data.
...
```{r logistic regression model_1 , echo=FALSE, warning=FALSE, message=FALSE}
